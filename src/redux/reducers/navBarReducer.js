let initialState = {
        friendInfo: [
            ...
            { id: 4, profileImage: "https://icon-library.com/images/small-cat-icon/small-cat-icon-1.jpg", name: "Котик" },
            { id: 5, profileImage: "https://icon-library.com/images/small-cat-icon/small-cat-icon-1.jpg", name: "Котик" }
        ]
};
